...
import { UpdateCondominium, DeleteCondominium } from '@/app/ui/condominio/buttons';
              ...
              {condominios?.map((condominios) => (
                ...
                >
                  <td className="whitespace-nowrap py-3 pl-6 pr-3">
                    <Link href={`/dashboard/calculo/${condominios.id}/calcular`} className="flex items-center gap-3">
                      {condominios.nome}
                    </Link>
                  </td>
